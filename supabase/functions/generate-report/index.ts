...
1. **What This Test Measures**: Explain what the RIASEC test measures in 2-3 sentences
2. **Your Results**: Present the Holland Code and top three career themes
3. **What This Means For You**: Provide actionable insights (3-4 paragraphs)
...
Format your response as structured JSON with this schema:
{
  ...
  "results": {
    "hollandCode": "Code",
    "topThemes": [{"rank": 1, "theme": "Theme", "score": 28}]
  },
  "insights": "Actionable insights text"
}`;
}
